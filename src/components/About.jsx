...
export default function About() {
  return (
    <section id="about" className="w-full py-24 md:py-32 px-6 md:px-12 xl:px-20 flex justify-center"
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-start">
          ...
          <motion.div
            ...
            <div className="mb-8 flex items-center gap-4">
              ...
              <div>
                <p className="font-display font-bold text-base" style={{ color: "#E8E1D3" }}>Tanzeela Arshad</p>
                <p className="font-mono text-[10px] uppercase tracking-wider mt-0.5" style={{ color: "#6B1E2B" }}>
                  Hafiza · AI Engineer · Developer
                </p>
              </div>
            </div>

            <h2 className="font-display font-black text-4xl md:text-5xl leading-[1.1] mb-6"
              style={{ color: "#E8E1D3" }}>
            ...
            <div className="space-y-4 font-body text-base leading-relaxed" style={{ color: "#A09585" }}>
              <p>
                I'm Tanzeela — a Full Stack Developer and Agentic AI Engineer from Karachi, Pakistan,
                building AI systems that work in the real world, not just in demos.
              </p>
              <p>
                As <strong style={{ color: "#E8E1D3" }}>Team Lead</strong> of KaamYaar AI, I architected
                an 8-agent platform for Pakistan's informal gig economy — multilingual, deployed on
                Google Cloud Run, with women safety features built into the core.
              </p>
              <p>
                Attended <strong style={{ color: "#E8E1D3" }}>KhiNext'26</strong> as an official
                delegate — Asia's first multi-domain AI &amp; Innovation Summit. Parallel to building,
                studying Ethical Hacking at SMIT × Cisco NetAcad.
              </p>
            </div>
          </motion.div>
            ...
            <div className="w-full rounded-2xl p-6 flex flex-col gap-3"
              ...
              {details.map((d, i) => (
                <motion.div
                  ...
                  className="flex items-start gap-3 p-3 rounded-xl cursor-default transition-all duration-200"
                  ...
                  <div>
                    ...
                    <p className="font-body font-semibold text-sm mt-0.5" style={{ color: "#E8E1D3" }}>{d.value}</p>
                  </div>
                </motion.div>
              ))}
            </div>
